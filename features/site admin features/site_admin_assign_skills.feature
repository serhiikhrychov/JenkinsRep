@chrome
Feature: Site Admin Assign Skills
  ...
  Scenario: Site Admin is able to open 'Assign Skills' page
    ...
    And I open 'Assign Skills' page
    Then I should see 'Assign Skills' page for site admin

  Scenario: Site Admin should see notification after 'Assign' button was clicked
    Given I login with id 'autotestuser1@mailinator.com' and the password 'medicine'
    When I click on 'Admin' link
  ...
  Scenario: Site Admin is able to assign skill to user
    Given I login with id 'autotestuser1@mailinator.com' and the password 'medicine'
    When I click on 'Admin' link
    And I fill in 'Search' field with 'autotestuser1@mailinator.com'
    And I press 'Enter' button for search field
    ...
    Then I should see 'The assignments will take some time to show up' notification

  Scenario: Site Admin is able to assign several skills to user
    Given I login with id 'autotestuser1@mailinator.com' and the password 'medicine'
    When I click on 'Admin' link
    And I fill in 'Search' field with 'autotestuser1@mailinator.com'
    And I press 'Enter' button for search field
  ...
  Scenario: Site Admin is able to assign skill to user and check the skills
    Given I login with id 'autotestuser1@mailinator.com' and the password 'medicine'
    When I click on 'Admin' link
    And I open 'Add User' page
    And I create user with skills and login as newly created user:
      | Skill_Name | Skill_category | Skill_level |
      | 25         | 25             | 25          |
    Then I should see '25' skill

  Scenario: Site Admin should see notification after 'Assign' button was clicked without user selection
    Given I login with id 'autotestuser1@mailinator.com' and the password 'medicine'
    When I click on 'Admin' link
    And I open 'Assign Skills' page
    And I select skills:
  ...
  Scenario: Site Admin is able to close notification after 'Assign' button was clicked without user selection
    Given I login with id 'autotestuser1@mailinator.com' and the password 'medicine'
    When I click on 'Admin' link
    And I open 'Assign Skills' page
    And I select skills:
  ...
  Scenario: Site Admin is able to click on 'Assign' button without skill selection
    Given I login with id 'autotestuser1@mailinator.com' and the password 'medicine'
    When I click on 'Admin' link
    And I fill in 'Search' field with 'autotestuser1@mailinator.com'
    And I press 'Enter' button for search field
  ...
  Scenario: Site Admin is able to close notification after 'Assign' button was clicked without skill selection
    Given I login with id 'autotestuser1@mailinator.com' and the password 'medicine'
    When I click on 'Admin' link
    And I fill in 'Search' field with 'autotestuser1@mailinator.com'
    And I press 'Enter' button for search field
  ...
  Scenario: Site Admin is able to cancel adding skills
    Given I login with id 'autotestuser1@mailinator.com' and the password 'medicine'
    When I click on 'Admin' link
    And I fill in 'Search' field with 'autotestuser1@mailinator.com'
    And I press 'Enter' button for search field
    ...
    Then I should not see 'The assignments will take some time to show up' notification
  ...
  Scenario:  Click on 'Select all' button after the unselection of skill
    Given I login with id 'autotestuser1@mailinator.com' and the password 'medicine'
    When I click on 'Admin' link
    And I open 'Assign Skills' page
    And I click on 'Select all' button
  ...
  Scenario: Site Admin is able to do searching by one char
    ...
    When I click on 'Admin' link
    And I open 'Assign Skills' page
    And I fill '26' in search field
    And I press 'Enter' button for search field in pop up
    Then I should see '26' skill as first
...
#  Issue which was reported - OP-1310
